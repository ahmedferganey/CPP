...
int main() 
{
    ...
    std::cout << "std::size_t is signed = "     << std::numeric_limits<std::size_t>::is_signed      << "\n";
    std::cout << "ssize_t is signed = "         << std::numeric_limits<ssize_t>::is_signed          << "\n";            

  

    struct alignas(4) Practical_Considerations_with_Cpp_Data_Types
    {
        /* data */
    ...
    std::cout << "alignment of Practical_Considerations_with_Cpp_Data_Types = "     << alignof(Practical_Considerations_with_Cpp_Data_Types) << "\n";
    std::cout << "size of Practical_Considerations_with_Cpp_Data_Types = "          << sizeof(Practical_Considerations_with_Cpp_Data_Types)  << "\n";
